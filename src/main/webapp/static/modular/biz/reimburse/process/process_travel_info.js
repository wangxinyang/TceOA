...
ProcessInfoDlg.approveByAjax = function(type) {
    ...
    var keyWord = '';
    if(type == 'pass') {
        url = Feng.ctxPath + "/reimburse/process/approve/pass"
        keyWord = "审核";
    } else {
        url = Feng.ctxPath + "/reimburse/process/approve/unPass"
        keyWord = "驳回";
    }
    //提交信息
    $.ajax({
...
$(function () {
    Feng.initValidator("processInfoForm", ProcessInfoDlg.validateFields);
});
